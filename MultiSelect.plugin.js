/**
 * @name MultiSelect
 * @source https://raw.githubusercontent.com/lol219/MultiSelect/main/MultiSelect.plugin.js
 * @authorId 
 */
/* @cc_on
@if (@_jscript)
...
const MultiSelect = (() => {
	class MultiSelect {
    getName() {return "MultiSelect";}
    getDescription() {return "Allows you to select multiple users (hold ctrl or shift while click on them) in a voice chat to move them, you can also ctrl/shift click a voice channel to select all";}
    getVersion() {return "1.0.8";}
    getAuthor() {return "Alexandro";}

    start() {
        if (!global.ZeresPluginLibrary) return window.BdApi.alert("Library Missing",`The library plugin needed for ${this.getName()} is missing.<br /><br /> <a href="https://betterdiscord.net/ghdl?url=https://raw.githubusercontent.com/rauenzi/BDPluginLibrary/master/release/0PluginLibrary.plugin.js" target="_blank">Click here to download the library!</a>`);
        ZLibrary.PluginUpdater.checkForUpdate(this.getName(), this.getVersion(), "https://raw.githubusercontent.com/lol219/MultiSelect/main/MultiSelect.plugin.js");
      }
  ...
  const config = {
    info: {
      ...
      github_raw: 'https://raw.githubusercontent.com/lol219/MultiSelect/main/MultiSelect.plugin.js',
    },
    changelog: [
	  {
        title: 'Cancel Toast',
